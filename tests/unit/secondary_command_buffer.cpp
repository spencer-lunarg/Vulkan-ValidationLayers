...
TEST_F(NegativeSecondaryCommandBuffer, InheritanceDescriptorHeapInfo) {
    ...
    resource_heap_bind_info.heapRange.address = resource_buffer.Address();
    resource_heap_bind_info.heapRange.size = resource_buffer.CreateInfo().size;
    sampler_heap_bind_info.heapRange.address = resource_buffer.Address();
    sampler_heap_bind_info.heapRange.size = resource_buffer.CreateInfo().size;
