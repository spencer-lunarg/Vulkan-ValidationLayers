...
TEST_F(NegativeRayTracingPipeline, DescriptorHeapShaderRecordData) {
    ...
    VkDescriptorSetAndBindingMappingEXT mapping[2] = {vku::InitStructHelper(), vku::InitStructHelper()};
    mapping[1].descriptorSet = 0;
    mapping[1].firstBinding = 0;
    mapping[1].bindingCount = 1;
    mapping[1].resourceMask = VK_SPIRV_RESOURCE_TYPE_ALL_EXT;
    ...
    mapping[0].firstBinding = 1;
    mapping[0].bindingCount = 1;
    mapping[0].resourceMask = VK_SPIRV_RESOURCE_TYPE_ALL_EXT;
