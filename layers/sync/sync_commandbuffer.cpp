...
// TODO - Code gen these
// clang-format off
static const SyncStageAccessFlags SYNC_VERTEX_SHADER_ALL =
    SYNC_VERTEX_SHADER_ACCELERATION_STRUCTURE_READ_BIT | SYNC_VERTEX_SHADER_DESCRIPTOR_BUFFER_READ_BIT_EXT |
    SYNC_VERTEX_SHADER_SHADER_BINDING_TABLE_READ_BIT | SYNC_VERTEX_SHADER_SHADER_SAMPLED_READ_BIT |
    SYNC_VERTEX_SHADER_SHADER_STORAGE_READ_BIT | SYNC_VERTEX_SHADER_UNIFORM_READ_BIT;
static const SyncStageAccessFlags SYNC_FRAGMENT_SHADER_ALL =
    SYNC_FRAGMENT_SHADER_ACCELERATION_STRUCTURE_READ_BIT | SYNC_FRAGMENT_SHADER_DESCRIPTOR_BUFFER_READ_BIT_EXT |
    SYNC_FRAGMENT_SHADER_SHADER_BINDING_TABLE_READ_BIT | SYNC_FRAGMENT_SHADER_SHADER_SAMPLED_READ_BIT |
    SYNC_FRAGMENT_SHADER_SHADER_STORAGE_READ_BIT | SYNC_FRAGMENT_SHADER_UNIFORM_READ_BIT;
static const SyncStageAccessFlags SYNC_GEOMETRY_SHADER_ALL =
    SYNC_GEOMETRY_SHADER_ACCELERATION_STRUCTURE_READ_BIT | SYNC_GEOMETRY_SHADER_DESCRIPTOR_BUFFER_READ_BIT_EXT |
    SYNC_GEOMETRY_SHADER_SHADER_BINDING_TABLE_READ_BIT | SYNC_GEOMETRY_SHADER_SHADER_SAMPLED_READ_BIT |
    SYNC_GEOMETRY_SHADER_SHADER_STORAGE_READ_BIT | SYNC_GEOMETRY_SHADER_UNIFORM_READ_BIT;
static const SyncStageAccessFlags SYNC_TESSELLATION_CONTROL_SHADER_ALL =
    ...
    SYNC_TESSELLATION_CONTROL_SHADER_SHADER_BINDING_TABLE_READ_BIT | SYNC_TESSELLATION_CONTROL_SHADER_SHADER_SAMPLED_READ_BIT |
    SYNC_TESSELLATION_CONTROL_SHADER_SHADER_STORAGE_READ_BIT | SYNC_TESSELLATION_CONTROL_SHADER_UNIFORM_READ_BIT;
static const SyncStageAccessFlags SYNC_TESSELLATION_EVALUATION_SHADER_ALL =
    ...
    SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_SAMPLED_READ_BIT | SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_STORAGE_READ_BIT |
    SYNC_TESSELLATION_EVALUATION_SHADER_UNIFORM_READ_BIT;
static const SyncStageAccessFlags SYNC_COMPUTE_SHADER_ALL =
    SYNC_COMPUTE_SHADER_ACCELERATION_STRUCTURE_READ_BIT | SYNC_COMPUTE_SHADER_DESCRIPTOR_BUFFER_READ_BIT_EXT |
    SYNC_COMPUTE_SHADER_SHADER_BINDING_TABLE_READ_BIT | SYNC_COMPUTE_SHADER_SHADER_SAMPLED_READ_BIT |
    SYNC_COMPUTE_SHADER_SHADER_STORAGE_READ_BIT | SYNC_COMPUTE_SHADER_UNIFORM_READ_BIT;
static const SyncStageAccessFlags SYNC_RAY_TRACING_SHADER_ALL =
    SYNC_RAY_TRACING_SHADER_ACCELERATION_STRUCTURE_READ_BIT | SYNC_RAY_TRACING_SHADER_DESCRIPTOR_BUFFER_READ_BIT_EXT |
    SYNC_RAY_TRACING_SHADER_SHADER_BINDING_TABLE_READ_BIT | SYNC_RAY_TRACING_SHADER_SHADER_SAMPLED_READ_BIT |
    SYNC_RAY_TRACING_SHADER_SHADER_STORAGE_READ_BIT | SYNC_RAY_TRACING_SHADER_UNIFORM_READ_BIT;
static const SyncStageAccessFlags SYNC_MESH_SHADER_EXT_ALL =
    SYNC_MESH_SHADER_EXT_ACCELERATION_STRUCTURE_READ_BIT | SYNC_MESH_SHADER_BIT_EXT_DESCRIPTOR_BUFFER_READ_BIT_EXT |
    SYNC_MESH_SHADER_EXT_SHADER_BINDING_TABLE_READ_BIT | SYNC_MESH_SHADER_EXT_SHADER_SAMPLED_READ_BIT |
    SYNC_MESH_SHADER_EXT_SHADER_STORAGE_READ_BIT | SYNC_MESH_SHADER_EXT_UNIFORM_READ_BIT;
static const SyncStageAccessFlags SYNC_TASK_SHADER_EXT_ALL =
    SYNC_TASK_SHADER_EXT_ACCELERATION_STRUCTURE_READ_BIT | SYNC_TASK_SHADER_BIT_EXT_DESCRIPTOR_BUFFER_READ_BIT_EXT |
    SYNC_TASK_SHADER_EXT_SHADER_BINDING_TABLE_READ_BIT | SYNC_TASK_SHADER_EXT_SHADER_SAMPLED_READ_BIT |
    SYNC_TASK_SHADER_EXT_SHADER_STORAGE_READ_BIT | SYNC_TASK_SHADER_EXT_UNIFORM_READ_BIT;
static const SyncStageAccessFlags SYNC_SUBPASS_SHADER_HUAWEI_ALL =
    SYNC_SUBPASS_SHADER_HUAWEI_ACCELERATION_STRUCTURE_READ_BIT | SYNC_SUBPASS_SHADER_HUAWEI_DESCRIPTOR_BUFFER_READ_BIT_EXT |
    SYNC_SUBPASS_SHADER_HUAWEI_INPUT_ATTACHMENT_READ_BIT | SYNC_SUBPASS_SHADER_HUAWEI_SHADER_BINDING_TABLE_READ_BIT |
    SYNC_SUBPASS_SHADER_HUAWEI_SHADER_SAMPLED_READ_BIT | SYNC_SUBPASS_SHADER_HUAWEI_SHADER_STORAGE_READ_BIT |
    SYNC_SUBPASS_SHADER_HUAWEI_UNIFORM_READ_BIT;
static const SyncStageAccessFlags SYNC_CLUSTER_CULLING_SHADER_HUAWEI_ALL =
    ...
    SYNC_CLUSTER_CULLING_SHADER_HUAWEI_SHADER_BINDING_TABLE_READ_BIT | SYNC_CLUSTER_CULLING_SHADER_HUAWEI_SHADER_SAMPLED_READ_BIT |
    SYNC_CLUSTER_CULLING_SHADER_HUAWEI_SHADER_STORAGE_READ_BIT | SYNC_CLUSTER_CULLING_SHADER_HUAWEI_UNIFORM_READ_BIT;
static const SyncStageAccessFlags SYNC_ACCELERATION_STRUCTURE_BUILD_ALL =
    SYNC_ACCELERATION_STRUCTURE_BUILD_ACCELERATION_STRUCTURE_READ_BIT |
    SYNC_ACCELERATION_STRUCTURE_BUILD_INDIRECT_COMMAND_READ_BIT | SYNC_ACCELERATION_STRUCTURE_BUILD_MICROMAP_READ_BIT_EXT |
    SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_STORAGE_READ_BIT | SYNC_ACCELERATION_STRUCTURE_BUILD_TRANSFER_READ_BIT;
//clang-format on
...
static std::string string_SyncStageAccessFlags(SyncStageAccessFlags flags, const char *sep = "|") {
    ...
    if (flags.none()) {
        ...
        if ((flags & SYNC_VERTEX_SHADER_ALL) == SYNC_VERTEX_SHADER_ALL) {
            out_str.append("-SYNC_VERTEX_SHADER_ALL-");
            flags &= ~SYNC_VERTEX_SHADER_ALL;
        }
        if ((flags & SYNC_FRAGMENT_SHADER_ALL) == SYNC_FRAGMENT_SHADER_ALL) {
            out_str.append("-SYNC_FRAGMENT_SHADER_ALL-");
            flags &= ~SYNC_FRAGMENT_SHADER_ALL;
        }
        if ((flags & SYNC_GEOMETRY_SHADER_ALL) == SYNC_GEOMETRY_SHADER_ALL) {
            out_str.append("-SYNC_GEOMETRY_SHADER_ALL-");
            flags &= ~SYNC_GEOMETRY_SHADER_ALL;
        }
        if ((flags & SYNC_TESSELLATION_CONTROL_SHADER_ALL) == SYNC_TESSELLATION_CONTROL_SHADER_ALL) {
            out_str.append("-SYNC_TESSELLATION_CONTROL_SHADER_ALL-");
            flags &= ~SYNC_TESSELLATION_CONTROL_SHADER_ALL;
        }
        if ((flags & SYNC_TESSELLATION_EVALUATION_SHADER_ALL) == SYNC_TESSELLATION_EVALUATION_SHADER_ALL) {
            out_str.append("-SYNC_TESSELLATION_EVALUATION_SHADER_ALL-");
            flags &= ~SYNC_TESSELLATION_EVALUATION_SHADER_ALL;
        }
        if ((flags & SYNC_COMPUTE_SHADER_ALL) == SYNC_COMPUTE_SHADER_ALL) {
            out_str.append("-SYNC_COMPUTE_SHADER_ALL-");
            flags &= ~SYNC_COMPUTE_SHADER_ALL;
        }
        if ((flags & SYNC_RAY_TRACING_SHADER_ALL) == SYNC_RAY_TRACING_SHADER_ALL) {
            out_str.append("-SYNC_RAY_TRACING_SHADER_ALL-");
            flags &= ~SYNC_RAY_TRACING_SHADER_ALL;
        }
        if ((flags & SYNC_MESH_SHADER_EXT_ALL) == SYNC_MESH_SHADER_EXT_ALL) {
            out_str.append("-SYNC_MESH_SHADER_EXT_ALL-");
            flags &= ~SYNC_MESH_SHADER_EXT_ALL;
        }
        if ((flags & SYNC_TASK_SHADER_EXT_ALL) == SYNC_TASK_SHADER_EXT_ALL) {
            out_str.append("-SYNC_TASK_SHADER_EXT_ALL-");
            flags &= ~SYNC_TASK_SHADER_EXT_ALL;
        }
        if ((flags & SYNC_SUBPASS_SHADER_HUAWEI_ALL) == SYNC_SUBPASS_SHADER_HUAWEI_ALL) {
            out_str.append("-SYNC_SUBPASS_SHADER_HUAWEI_ALL-");
            flags &= ~SYNC_SUBPASS_SHADER_HUAWEI_ALL;
        }
        if ((flags & SYNC_CLUSTER_CULLING_SHADER_HUAWEI_ALL) == SYNC_CLUSTER_CULLING_SHADER_HUAWEI_ALL) {
            out_str.append("-SYNC_CLUSTER_CULLING_SHADER_HUAWEI_ALL-");
            flags &= ~SYNC_CLUSTER_CULLING_SHADER_HUAWEI_ALL;
        }
        if ((flags & SYNC_ACCELERATION_STRUCTURE_BUILD_ALL) == SYNC_ACCELERATION_STRUCTURE_BUILD_ALL) {
            out_str.append("-SYNC_CLUSTER_CULLING_SHADER_HUAWEI_ALL-");
            flags &= ~SYNC_ACCELERATION_STRUCTURE_BUILD_ALL;
        }
